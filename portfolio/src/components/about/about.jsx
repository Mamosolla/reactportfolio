...
export class about extends Component {
  render() {
    return (
      ...
      <p>
       I am a determined individual who enjoys learning new skills in order to improve my skills.
      </p>
      <div className="hero-content flex-col lg:flex-row">
        <img
          src={require('../../assets/images/kagiso.jpeg')}
        ...
        <div className="">
          ...
          <div className="flex lg:flex-row sm:flex-row-1 space-x-8 justify-center text-left mt-8 mr-8">
            ...
            <ul>
              <li>Email:Kagisomamosolla@gmail.com</li>
              <li>Phone:0767195617 </li>
      ...
      <div className="flex flex-wrap justify-center a">
